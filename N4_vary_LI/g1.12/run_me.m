...
prob = ode_BP2ep(prob, '', 'run_symm', labs(3));
...
prob = ode_HB2po(prob, '', 'run_loop', labs(2));
coco(prob, 'run_loop_HB_02', [], 1, {'lambdaI', 'g', 'po.period'}, LI_lim);
...
prob = coco_set(prob, 'coll', 'NTST', 20, 'NCOL', 4);
prob = coco_set(prob, 'cont',   'h0' , 0.001, 'h_min', 1e-12, 'h_max', 0.1, 'NAdapt', 10, 'PtMX', [0,2000]);
prob = ode_HB2po(prob, '', 'run_loop', labs(3));
coco(prob, 'run_loop_HB_03', [], 1, {'lambdaI', 'g', 'po.period'}, LI_lim);
...
prob = coco_set(prob, 'ode', 'vectorized', true);
prob = coco_set(prob, 'coll', 'NTST', 20, 'NCOL', 4);
prob = coco_set(prob, 'cont',   'h0' , 0.001, 'h_min', 1e-12, 'h_max', 0.1, 'NAdapt', 10, 'PtMX', [0,12000]);
prob = ode_HB2po(prob, '', 'run_loop', labs(1));
coco(prob, 'run_loop_HB_01', [], 1, {'lambdaI', 'g', 'po.period'}, LI_lim);
%% Loop-branch HB
...
prob = coco_set(prob, 'coll', 'NTST', 20, 'NCOL', 4);
prob = coco_set(prob, 'cont',   'h0' , 0.001, 'h_min', 1e-12, 'h_max', 0.1, 'NAdapt', 10, 'PtMX', [0,12000]);
prob = ode_HB2po(prob, '', 'run_loop', labs(4));
coco(prob, 'run_loop_HB_04', [], 1, {'lambdaI', 'g', 'po.period'}, LI_lim);
