...
zero_min = -5; % Lower limit for the region below triv_0 curve
...
box on;
exportgraphics(gcf, 'N4_c2_trivsync_transposed.eps', 'Resolution', 300);
...
box on;
exportgraphics(gcf, 'N10_c2_trivsync_transposed.eps', 'Resolution', 300);
